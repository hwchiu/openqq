...
6. `OpenShell + gVisor` 在這輪的 OpenShell guardrails 也通過，代表 L7 與 filesystem guardrails 在目前 patcher / CRI-O 路線下可工作；但這不等於裸 `gvisor` probe 已經穩定。
