...
> Update 2026-06-10: plain CRI-O 的 follow-up live rerun 已在 pinned flannel CNI config 下恢復 baseline smoke。這份文件保留修正前 baseline 上的第一次 blocked observation；OpenShell 1.34 需要在修正後基線上重跑，才能保留或推翻這個結論。
